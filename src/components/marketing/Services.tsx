    ...
    <section id="services" className="py-32 bg-surface">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-brand font-semibold text-sm uppercase tracking-widest mb-4">What We Build</p>
        ...
        <div className="space-y-4">
          {services.map((service, i) => (
            <div
              key={i}
              className="rounded-xl border border-ink/8 bg-canvas overflow-hidden shadow-sm"
            >
              <div className="grid grid-cols-1 md:grid-cols-2">
                {/* Problem */}
                <div className="p-8 border-b md:border-b-0 md:border-r border-ink/8 bg-rose-50">
                  <div className="flex items-center gap-2 text-rose-600/70 text-xs font-semibold uppercase tracking-widest mb-4">
                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd"/>
                    </svg>
                    The problem
                  </div>
                  <p className="text-ink/65 text-base leading-relaxed">{service.pain}</p>
                </div>
                ...
                <div className="p-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-display text-ink font-semibold text-lg tracking-tight">{service.solution}</h3>
                  </div>
